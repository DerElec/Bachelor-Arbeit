# -*- coding: utf-8 -*-
"""
Created on Sat May 11 14:57:10 2024

@author: holli
"""

from sympy import symbols, I, Function, Eq, solve, conjugate, solveset, S
import numpy as np
...
# Versuch, das System mit 'solve' zu lösen
# try:
#     # solutions = solveset([eq1, eq1_conj, eq2, eq2_conj, eq3, eq3_conj, eq4, eq4_conj, eq5, eq5_conj, eq6, eq6_conj, eq7,
#     #                    eq7_conj], (psi12, psi21),#(a, a_dagger, psi00, psi11, psi22, psi01, psi10, psi02, psi20, psi12, psi21),
#     #                   domain=S.Complexes)
#     solutions = solve([eq1, eq1_conj, eq2, eq2_conj]#, eq3, eq3_conj, eq4, eq4_conj , eq5, eq5_conj, eq6, eq6_conj, eq7,eq7_conj]
#                       , (psi11),#(a, a_dagger, psi00, psi11, psi22, psi01, psi10, psi02, psi20, psi12, psi21),
#                       dict=True)
#     if solutions:
#         print("Das System ist lösbar:", solutions)
#     else:
#         print("Das System hat keine Lösung.", solutions)
# except Exception as e:
#     print("Beim Lösen des Systems trat ein Fehler auf:", str(e))
...
equation1 = Eq(2*x + 3*y*z, 5)
equation2 = Eq(4*x - y*x, 0)
